...
class ECG_XNOR_Full_Bin_LP(nn.Module):
    def __init__(self, block1, block2, block3, block4, block5, block6, block7, device):
        super(ECG_XNOR_Full_Bin_LP, self).__init__()
        self.name = 'Full_Bin_LP_ECG'

        self.device = device
        self.block1 = Bn_bin_conv_pool_block_baw(*block1)  #input 量化为8bit
