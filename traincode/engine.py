...
#               device: torch.device,
#               ) -> Tuple[float, float]:
#     """Evaluate `model` on `dataloader`, return (loss, accuracy),
#     **and print a histogram of predicted classes 0-4.**
#     """
#     model.eval()
#     test_loss, correct, total = 0, 0, 0
#
#     # --- keep a running tally of predictions ---
...
#
#             # accumulate class histogram
#             for cls in predicted.cpu().tolist():
#                 class_counts[cls] += 1
#
...
#     for cls in range(5):                       # classes 0‒4
...
def train(model: torch.nn.Module,
    ...
    for epoch in range(epochs):
        ...
        if test_acc > best_test_acc:
            ...
            if test_acc >= 0.85:
                # weight_op.WeightBinarize()
                save_filepath = f"ECG_Net_LP_{classes_num}_{acc_str}.pth"
                save_model(model=model,target_dir="LPmodels",model_name=save_filepath)
